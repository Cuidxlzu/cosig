...
Various tools can be used to illustrate the similarity of two sources of text, including \href{https://people.f4.htw-berlin.de/~weberwu/simtexter/app.html}{similarity texter}, \href{https://app.copyleaks.com/text-compare}{Text compare by Copyleaks} and \href{https://plagiarism.bloomfieldmedia.com/software/}{WCopyfind/Copyfind} (which can compare more than two documents).
