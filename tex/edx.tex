...
The characteristic X-ray energies that will be produced by each element can be found in various lookup tables, like \href{https://xdb.lbl.gov/Section1/Table_1-2.pdf}{this one from Lawrence Berkeley National Laboratory}, available \href{https://xdb.lbl.gov/Section1/Periodic_Table/X-ray_Elements.html}{here} in the form of a periodic table (look under ``K and L shell emission lines in electron volts'' after clicking on an element). However, the most convenient and comprehensive resource for determining expected peaks is the software \href{https://www.cstl.nist.gov/div837/837.02/epq/dtsa2/index.html}{NIST DTSA-II}. DTSA-II also allows the user to simulate spectra and quantify elemental abundances from real spectra.
