...
\subsection*{Example 3: Treating binary classification as multiclass}

\href{https://doi.org/10.1016/j.comcom.2022.08.015}{Ravi et al. (2022)} present classifier metrics for the detection of Android malware. This is a binary classification problem: a given piece of code is either malware or not.
However, one cannot obtain the accuracy, precision, and recall values shown in their Table 6 from the confusion matrices shown in that same table.

This is likely because, as shown by \href{https://pubpeer.com/publications/8C0482DFDFB7923AA5D156709FAA32}{PubPeer commenter Nerita Vitiensis}, the authors treated this as a multiclass classification problem, evaluating the positive and negative cases independently and averaging the results. This is not a correct way to handle a binary classification problem.

\begin{figure}[h!tbp]
    \centering
    \includegraphics[width=0.8\textwidth]{img/multiclass_classifiers/binary_as_multiclass.png}
    \caption*{Adapted from Table 6 of \href{https://doi.org/10.1016/j.comcom.2022.08.015}{Ravi et al. (2022)}.}
\end{figure}
