...
\cosigsection{Citations to retracted publications}{9 March 2026}
...
However, not all retracted articles are cited after their retraction (post-retraction citations), and not all citations serve the same purpose. It is important to consider the context in which a retracted article is cited. A retraction in the references does not automatically make all citing articles unreliable, but citations to retracted publications can serve as a fingerprint for identifying potential issues in the literature. This guide provides information about how to identify such citations and what nuances should be considered in the analysis and reporting of these cases. 
...
Retractions can happen for non-scientific content related reasons. %This can potentially reduce the idea of ‘propagation of unreliable science’. 
The \href{https://retractionwatch.com/retraction-watch-database-user-guide/retraction-watch-database-user-guide-appendix-b-reasons/}{Retraction Watch Database User Guide Appendix B: Reasons} describes various common reasons why retractions occur. For example, an article being retracted based on the content of the publication (e.g., retraction reasons ``error in data/analyses'', ``error in cell lines'') can imply a potential reliability issue for the citing work if the data and analyses of this publication were a central part of the citing work. This information is particularly helpful when analyzing large amounts of citations since it can be obtained from the joint database of \href{https://gitlab.com/crossref/retraction-watch-data}{Retraction Watch and Crossref}. For case-by-case analyses, retraction notices can provide more detailed and accurate information about reasoning. 
...
\subsection*{What to do when an article you have cited gets retracted}

\href{https://www.retracted.net/}{RetractoBot} checks PubMed for retracted articles, finds all the articles that cite those retracted articles, and alerts the authors of those articles about the retractions. It is important to take action accordingly if you figure out or get notified when a study you have cited gets retracted.\href{https://retractionwatch.com/2016/11/01/what-should-you-do-if-a-paper-youve-cited-is-later-retracted/}{Retraction Watch's guide}, which gathers tips from the \href{https://publicationethics.org/guidance/case/citing-retracted-paper}{Committee on Publication Ethics (COPE)}, suggests the author(s) ask themselves several questions:

\begin{enumerate}
    \setlength\itemsep{-0.5em}
    \item Check whether the retraction impacts your article's results.
    \item Check the reasoning behind the retraction to understand whether the problem was data unreliability, ethical issues or minor errors. This can help assess the impact of the citation.
    \item If it impacts the results, contact the editor and request a correction, erratum or retraction to your article as appropriate.
    \item If it does not impact the results, usually no action is needed.%, but stay transparent and proactive
\end{enumerate}

These steps are parallel to the process of analyzing citations to retracted articles for the purpose of post-publication peer review. It may also be advisable to post a comment on \href{https://pubpeer.com/}{PubPeer} for your own article to document your awareness of the cited retracted article and to provide your assessment of its relevance and impact on your work.
...
\begin{itemize}
    ...
    \item \href{https://retractionwatch.com/2016/11/01/what-should-you-do-if-a-paper-youve-cited-is-later-retracted/}{``What should you do if a paper you’ve cited is later retracted?'' (2016)}
    \item \href{https://retractionwatch.com/2018/01/05/ask-retraction-watch-ok-cite-retracted-paper/}{``Ask Retraction Watch: Is it OK to cite a retracted paper?'' (2018)}
